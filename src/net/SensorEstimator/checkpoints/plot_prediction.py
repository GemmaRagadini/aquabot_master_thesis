...
Uso:
  ...
  python3 src/net/SensorEstimator/checkpoints/plot_prediction.py --checkpoint src/net/SensorEstimator/checkpoints/best.pt --trial ./src/net/dataset/trial_20260519_152944.csv ==> per specificare quale trial
